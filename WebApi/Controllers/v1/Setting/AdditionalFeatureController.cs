...
public class AdditionalFeatureController : BaseApiController
{
    ...
    /// <returns></returns>
    [HttpPost]
    public async Task<IActionResult> Create(CreateAdditionalFeatureCommand command)
    {
    ...
    public async Task<IActionResult> GetAll()
    {
        ...
        var obj = await Mediator.Send(new GetAllAdditionalFeaturesQuery());
    ...
    {
        var obj = await Mediator.Send(new GetAdditionalFeatureByIdQuery { Id = id });
        return StatusCode(obj.StatusCode,  (AdditionalFeatureDto)obj.Data);
    ...
    {
        var obj = await Mediator.Send(new DeleteAdditionalFeatureByIdCommand { Id = id });
        return StatusCode(obj.StatusCode,  (AdditionalFeatureDto)obj.Data);
    }
    /// <summary>
    ...
    /// <returns></returns>
    [HttpPut("[action]")]
    public async Task<IActionResult> Update(int id, UpdateAdditionalFeatureCommand command)
    {
        if (id != command.Id)
        {
            return BadRequest();
